...
namespace REslava.Result.AdvancedPatterns
{
    ...
    {
        private OneOf(T1? v1, T2? v2, T3? v3, T4? v4, T5? v5, T6? v6, byte index) : base(v1, v2, v3, v4, v5, v6, index) { }

        /// <summary>Creates a OneOf containing a T1 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT1(T1 value) => new(value, default, default, default, default, default, 0);

        /// <summary>Creates a OneOf containing a T2 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT2(T2 value) => new(default, value, default, default, default, default, 1);

        /// <summary>Creates a OneOf containing a T3 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT3(T3 value) => new(default, default, value, default, default, default, 2);

        /// <summary>Creates a OneOf containing a T4 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT4(T4 value) => new(default, default, default, value, default, default, 3);

        /// <summary>Creates a OneOf containing a T5 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT5(T5 value) => new(default, default, default, default, value, default, 4);

        /// <summary>Creates a OneOf containing a T6 value.</summary>
        public static OneOf<T1, T2, T3, T4, T5, T6> FromT6(T6 value) => new(default, default, default, default, default, value, 5);
